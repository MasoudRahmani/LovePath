...
1. For Config File to get which user has access to config file and ask for password.

2. Impersonate specified *User* in config file to open file/folder written for `LovePath` in config.
